...
# by GRA result from GRA.py, the top five features with the greatest relevance are High, Low, Open, ma5, ma10
data_Y = stock_data['Value']
data_X = stock_data.drop(columns=['Value', 'Adj Close', 'Close', 'Volume', 'ma20'], axis=1)
